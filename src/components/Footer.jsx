...
export default function Footer() {
  ...
  return (
    <footer ref={footerRef} id="footer" className="relative bg-gray-100 text-white pb-10 pt-40 px-6 md:px-24 overflow-hidden border-t border-white/5">
      <div className="footer-content max-w-[1600px] w-full mx-auto flex flex-col items-center text-center">
        ...
        <a
          ...
          className="interactive group relative overflow-hidden rounded-full bg-black text-white px-[clamp(2rem,4vw,3rem)] py-[clamp(1rem,2vw,1.5rem)] font-bold text-[clamp(1rem,2vw,1.25rem)] tracking-wide transition-transform hover:scale-105 inline-flex items-center gap-3 mb-24 hover:shadow-2xl hover:shadow-black/50"
        >
        ...
        <div className="w-full flex flex-col md:flex-row justify-between items-center pt-8 border-t border-white/10 gap-6">
          ...
          <div className="flex gap-[clamp(1.5rem,3vw,2rem)] text-[clamp(0.75rem,1.5vw,0.875rem)] font-semibold tracking-wider uppercase text-gray-400">
            <a href="#" className="interactive hover:text-white transition-colors duration-300">Studio</a>

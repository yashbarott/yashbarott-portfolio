        ...
        <div className="relative w-full flex flex-col items-center pb-10">
          {projects.map((project, index) => {
            return (
              ...
              >
                <div className="p-6 md:p-16 w-full flex items-end justify-between gap-8 h-full">
                  <div className="flex-1 flex flex-col">
                    <h3 className="font-head text-[clamp(3rem,8vw,6rem)] font-bold leading-[0.9] tracking-tighter text-white mb-8">
                      {project.title1}
                      <br />
                    ...
                    <div className="flex gap-4 items-start">
                      ...
                      <p className="text-gray-300 text-[clamp(1rem,2vw,1.25rem)] leading-relaxed max-w-2xl">
                        {project.desc}
                      </p>
                    </div>
                  </div>
                  ...
                  <a
                    ...
                    className="flex-shrink-0 group relative inline-flex items-center justify-center w-16 h-16 md:w-20 md:h-20 rounded-full bg-gradient-to-br from-red-fire/30 to-transparent border border-red-fire/50 hover:border-red-fire hover:from-red-fire/50 transition-all duration-300 ease-out"
                  >
                    <ArrowUpRight className="w-6 h-6 md:w-8 md:h-8 text-red-fire group-hover:scale-110 transition-transform duration-300" />
                  </a>
                </div>
              </div>
            );
